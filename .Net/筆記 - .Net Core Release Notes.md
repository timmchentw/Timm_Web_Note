...
- ### [Dotnet Fiddle](https://dotnetfiddle.net/F01MAP)
...
- Regex.EnumerateSplits
  - 如同`Regex.Split`，開始支援`ReadOnlySpan<char>`的使用 (這種方法更為高效)
...
- Customize enum member names
  - 可直接在Serialize時，直接取Attribute value (而非property name)
